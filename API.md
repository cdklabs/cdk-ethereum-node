...
| <code><a href="#@cdklabs/cdk-ethereum-node.EthereumNode.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@cdklabs/cdk-ethereum-node.EthereumNode.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdklabs/cdk-ethereum-node.EthereumNode.with.parameter.mixins"></a>
